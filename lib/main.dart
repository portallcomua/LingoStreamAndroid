...
class _MainDashboardState extends State<MainDashboard> {
  ...
  final Map<String, Map<String, String>> localizedData = {
    'UK': {
      ...
      'start': 'СТАРТ',
      'stop': 'СТОП',
      'mode_title': 'Режим оптимізації перекладу субтитрів:',
      'mode_movie': 'Кіно & Серіали',
      'mode_pop': 'Поп-музика & Блоги',
      'mode_rock': '🎸 Рок-музика (Швидкі субтитри)',
      'media_title': '🎬 Колекції & Відео',
      'add_custom': 'Додати своє відео (URL-посилання)',
      'ad_banner': '🤖 ТУТ БУДЕ БАНЕР GOOGLE ADMOB (BANNER_ID) 🤖',
      'no_cc_title': 'Увага: Немає субтитрів! ⚠️',
      'no_cc_desc': 'Це відео не має англійських субтитрів. Будь ласка, увімкніть субтитри (CC) у плеєрі або оберіть інший трек з нашої колекції.',
      'btn_close': 'ЗРОЗУМІЛО',
      'update_title': 'Доступне оновлення! 🚀',
      'update_desc': 'Знайдено нову версію LingoStream. Рекомендуємо оновитися з GitHub.',
      'update_btn': 'ОНОВИТИ',
    },
    'EN': {
      ...
      'start': 'START',
      'stop': 'STOP',
      'mode_title': 'Subtitle Translation Optimization Mode:',
      'mode_movie': 'Movies & Series',
      'mode_pop': 'Pop Music & Vlogs',
      'mode_rock': '🎸 Rock Music (Fast Subtitles)',
      'media_title': '🎬 Collections & Video',
      'add_custom': 'Add Custom Video (URL Link)',
      'ad_banner': '🤖 GOOGLE ADMOB ADS PLACEHOLDER (BANNER_ID) 🤖',
      'no_cc_title': 'Warning: No Subtitles! ⚠️',
      'no_cc_desc': 'This video does not have English subtitles. Please enable captions (CC) in the player or choose another track.',
      'btn_close': 'GOT IT',
      'update_title': 'Update Available! 🚀',
      'update_desc': 'A new version of LingoStream found. Please update from GitHub.',
      'update_btn': 'UPDATE',
    }
  };
  ...
  // ВИПРАВЛЕНО: Коректний URL для GitHub API
